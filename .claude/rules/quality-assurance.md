...
# 4. Check business logic coverage
...
- GitHub Actions workflow runs `golangci-lint` and `go test`
- Pull requests must pass both checks
- Coverage reports are generated automatically

## Non-Negotiable

⚠️ **CRITICAL**: Never skip linter or test verification before committing code. These checks catch bugs, maintain code quality, and ensure consistency across the codebase.
